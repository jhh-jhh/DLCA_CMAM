...
from lib.models_convnext import *
from lib.moudule.fuse_feature_module import *
import os
import torch
import torch.nn as nn
import torch.nn.functional as F
...
class PolypPVT(nn.Module):
    def __init__(self, channel=32):
        ...
        self.backbone = convnext_small()  #[96, 192, 384, 768]
    ...
    def forward(self, x):
        ...
        cim_feature=self.cmam(cim_feature)
